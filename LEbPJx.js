...
var Terminal = Terminal || function(cmdLineContainer, outputContainer) {
  ...
  const accountnumbers = [
    'DE46430500010134329813 - Janne Leikkonen', 'DE464305000101343289813 - Bygg Nord AB ', 'DE46430500010134329213  - Svea Johansson'
  ];
...
const commands = [
  ...
  return {
    init: function() {
      output('<img align="left" src="logo.png" width= auto height="100" style="padding: 0px 10px 20px 0px"><h2 style="letter-spacing: 4px">Svenska Banken Database</h2><p>' + new Date() + '</p><p>skriv "hjälp" för hjälp / type "help" to get help</p>');
    },
    output: output
  }
};